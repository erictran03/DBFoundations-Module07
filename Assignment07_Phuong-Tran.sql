...
-- 2025-03-10,Phuong Tran,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_PTran')
	 Begin 
	  Alter Database [Assignment07DB_PTran] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_PTran;
	 End
	Create Database Assignment07DB_PTran;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_PTran;
...
-- <Put Your Code Here> --
Create View vProductInventoriesWithPreviousMonthCount
As
	Select Top 1000000 
	ProductName,
	InventoryDate,
